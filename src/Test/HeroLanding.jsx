...
const features = [
  {
    name: 'Upload Music',
    description: 'Create digital assets around your discograhy.',
    icon: CloudUploadIcon,
  },
  {
    name: 'Security',
    description:
      'Always in control of your personal information. Always in control of your Music.',
    icon: LockClosedIcon,
  },
  {
    name: 'Peer to Peer',
    description:
      'Peer to Peer payment system without any middlemen. Direct payments with transaction finality in seconds.',
    icon: RefreshIcon,
  },
  {
    name: 'Advanced Security',
    description:
      'Blockchain technology is as secure as it gets. You are in full control over your funds.',
    icon: ShieldCheckIcon,
  },
  {
    name: 'Novel Smart Contracts',
    description:
      'Avasound has created the frontier of music focused smart contracts.',
    icon: CogIcon,
  },
  {
    name: 'Accesscible',
    description: 'Set up metamask and you are good to go.',
    icon: ServerIcon,
  },
]
...
const blogPosts = [
  ...
  },
  {
    ...
    date: 'Mar 10, 2020',
    datetime: '2020-03-10',
    category: { name: 'Ecosystem', href: '#' },
    imageUrl: '/avax-head.png',
    preview:
      'Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit facilis asperiores porro quaerat doloribus, eveniet dolore. Adipisci tempora aut inventore optio animi., tempore temporibus quo laudantium.',
    author: {
      name: 'Avalanche',
      imageUrl: '/avaxlogo.png',
      href: '#',
    },
    readingLength: '4 min',
  },
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-8">
              <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                <div className="lg:pt-16 lg:pb-8">
                  ...
                  >
                    <span className="rounded-full bg-gradient-to-r from-teal-500 to-teal-700 px-3 py-0.5 text-xs font-semibold uppercase leading-5 tracking-wide text-white">
                      Artists & Labels
                    </span>
                    ...
                    <form action="#" className="sm:mx-auto sm:max-w-xl lg:mx-0">
                      {/* <div className="sm:flex">
                        ...
                        <div className="mt-3 sm:mt-0 sm:ml-3">
                          <button
                            type="submit"
                            className="block w-full rounded-md bg-gradient-to-r from-teal-500 to-teal-700 py-3 px-4 font-medium text-white shadow hover:from-teal-300 hover:to-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-gray-900"
                          >
                            Get Newsletter
                          </button>
                        </div>
            ...
            <div className="relative">
              <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <p className="mx-auto mt-5 max-w-prose text-xl text-gray-500">
                  Read through our documentation or take a look at the avalanche
                  ecosystem and other blockchain projects.
                </p>
              </div>
