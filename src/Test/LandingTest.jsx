                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                  <div className="lg:py-24">
                    ...
                    <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                      ...
                      <span className="block bg-gradient-to-r from-teal-200 to-teal-400 bg-clip-text pb-3 text-transparent sm:pb-5">
                        the future for music.
                      </span>
                    </h1>
                    <p className="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                      Avasound is the first of it's kind on the Avalanche
                      Network. Our mission is to put Artists and Record Labels
                      first, leveraging blockchain technology for direct payment
                      flow and low fees.
                    </p>
                      ...
                      >
                        <div className="sm:flex">
                          ...
                          <div className="mt-3 sm:mt-0 sm:ml-3">
                            <button
                              type="submit"
                              className="block w-full rounded-md bg-gradient-to-r from-teal-500 to-teal-800 py-3 px-4 font-medium text-white shadow hover:from-teal-600 hover:to-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-gray-900"
                            >
                              Updates please!
                            </button>
                          </div>
                        ...
                        <p className="mt-3 text-sm text-gray-300 sm:mt-4">
                          Signup to our newsletter to be up to date with our
                          development process. Before you start please read the{' '}
                          <a
                            href="#"
