...
const product = {
  ...
  sizes: [
    { name: 'Common', inStock: true },
    { name: 'Rare', inStock: true },
    { name: 'Exclusive', inStock: false },
  ],
}
const reviews = {
  average: 4,
...
const license = {
  href: '#',
  summary:
    'For personal use only. The original creator of this product is the sole owner of licensing and intellectual property.',
  content: `
    <h4>Overview</h4>
